...
const CreatePost = () => {
    ...
    const savePost = async ( data )=> await fetch('https://mi-proyecto-7bd3d-default-rtdb.firebaseio.com/postv2/.json',{
        method: 'post',
                ...
                <div className="row mt-5 d-flex justify-content-center">
                    <div className="col-12" style={{ maxWidth: '600px'}}>
                        <form className='form-group bg-dark p-5 rounded' onSubmit={handleSubmit(savePost)}>
                            ...
                            <Link to='/'><button type="submit"  className='btn btn-primary mt-3'>Enviar</button></Link> 
                        </form>
                    </div>
                </div>
            </div>
